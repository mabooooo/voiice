...
if (-not (Test-Path $PythonPath)) {
  throw "Project-local SenseVoice venv is missing. Run setup.ps1 first."
}
...
$env:MODELSCOPE_CACHE = Join-Path $LocalRoot "cache\modelscope"
...
Write-Host "Start SenseVoice local server" -ForegroundColor Cyan
